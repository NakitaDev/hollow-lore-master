...
The Knight can heal safely by running off the platform and going to the far left of the area, where Xero's attacks do not reach, or by running under the platform. Note that this kind of healing is not possible when fought in Godhome .
...
His grave message used to read "Here lies a Traitor" , which was changed to the current message ( "Cursed are those who turn against the King." ) after the public release version 1.0.2.8 . This has, however, not been changed in some translations of the game.
