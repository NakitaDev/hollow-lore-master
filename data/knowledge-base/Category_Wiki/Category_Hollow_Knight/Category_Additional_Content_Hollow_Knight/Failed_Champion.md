...
Source: https://hollowknight.fandom.com/wiki/Failed_Champion
...
Leap : Failed Champion only uses this attack after the first Phase. This makes Leaping Bludgeon much more common. Slam : The slam is much faster, and the shockwave created from the slam is much larger and taller. Barrels fall from this attack in all Phases. Leaping Bludgeon : The height of the jump is lower. Barrels fall from this attack in all Phases.
