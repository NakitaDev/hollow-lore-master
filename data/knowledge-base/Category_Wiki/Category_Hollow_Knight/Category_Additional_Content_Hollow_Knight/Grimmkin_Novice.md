...
Source: https://hollowknight.fandom.com/wiki/Grimmkin_Novice
...
Charge : Charges directly at the Knight with extreme speed. Flame Spray : Fires three fireballs at once, one directly forward and two diagonally. The Novice is then left vulnerable for a few seconds. Teleport : Teleports to a random place a constant distance away from the Knight to perform an attack.
...
Grimmkin Novices can be found in Greenpath , Crystal Peak , and the City of Tears .

Gallery

Trivia

When in combat with any Grimmkin, the Accordion Chase theme plays. Cut Grimmkin Novice sprites existed in the game's files prior to the release of Lifeblood . It was a different version of the Charge attack animation where the Grimmkin can be seen as a flame with a mask without clothing.
