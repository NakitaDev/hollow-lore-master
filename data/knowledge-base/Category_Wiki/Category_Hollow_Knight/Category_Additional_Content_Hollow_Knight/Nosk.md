...
Source: https://hollowknight.fandom.com/wiki/Nosk

Nosk is a hidden boss in Hollow Knight , Winged Nosk is its flying form. After defeating Nosk, a Pale Ore can be acquired.
...
When defeated, Infection bursts out of Nosk making it explode. It leaves behind only its counterfeit shell, which can be quite jovially thrown about by slashing at it, amidst puddles of Infection. The Knight can then collect a Pale Ore from a fossil in a cave further along.
...
It is important to keep tap-moving to dodge the Rain attack. Nosk attempts to track the Knight with these blobs, so standing in one place is dangerous, and if you move too much, the attack will back you into a corner. This is the only attack that is not nullified when hiding against the middle platform.
...
When it dies, Nosk drops the same shell that the Knight drops upon death, which can be hit around. Winged Nosk references Nosk's original concept design where it had wings and a longer tail. Nosk is shown in the Wanderer's Journal disguising itself with the body of a normal Husk bug as its head. Another concept art of Nosk going by the file name of "Mimic Spider" and featured in a Team Cherry interview shows it with a regular-angled Knight head, longer tail and a lack of spines along its back. Despite and along some other bosses, Nosk only has one phase. There is a glitch where Nosk can get stuck on the raised part of the arena, permanently charging into the side of the lip, giving the player a very easy fight.
