# Menu Styles (Hollow Knight)

Source: https://hollowknight.fandom.com/wiki/Menu_Styles_(Hollow_Knight)
...
Hidden Dreams and The Grimm Troupe

While the Hidden Dreams and The Grimm Troupe menu styles were added for their respective updates, the option to customize and switch between the different menu styles was not implemented until the Lifeblood Update.
...
The Steel Soul menu style requires completing any ending while playing in Steel Soul Mode . It has the same colour desaturation as the Void style. It has a crystal shimmering sound effect. It also features the ambient audio of Crystal Peak .
...
A different variant of the Godmaster menu style was data-mined and leaked prior to the content pack's release. An additional menu style, named the "Radiant Style", can be found in the game files.
